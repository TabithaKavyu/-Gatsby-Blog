    ...
    <StaticQuery
       ...
       render = { data => (
        ...
        <div className={styles.row}>
            ...
            <SocialButton site="github" username="TabithaKavyu"></SocialButton>
            <SocialButton site="linkedin" username="TabithaKavyu"></SocialButton>
            <SocialButton site="twitter" username="TabithaKavyu"></SocialButton>
        </div>
